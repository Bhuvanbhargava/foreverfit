...
import edu.foreverfit.DAO.CVSManager;
...
import edu.foreverfit.DAO.DatabaseHelper;
import edu.foreverfit.DAO.Fonte;
import edu.foreverfit.DAO.Machine;
import edu.foreverfit.DAO.Profile;
import edu.foreverfit.DAO.cardio.DAOOldCardio;
import edu.foreverfit.DAO.cardio.OldCardio;



import edu.foreverfit.bodymeasures.BodyPartListFragment;
import edu.foreverfit.fonte.FontesPagerFragment;
import edu.foreverfit.intro.MainIntroActivity;
import edu.foreverfit.machines.MachineFragment;
import edu.foreverfit.utils.CustomExceptionHandler;
import edu.foreverfit.utils.DateConverter;
import edu.foreverfit.utils.FileChooserDialog;
import edu.foreverfit.utils.ImageUtil;
import edu.foreverfit.utils.MusicController;
...
*/
        ...
        /*dataList.add(new DrawerItem(this.getResources().getString(R.string.menu_Workout), R.drawable.ic_barbell, false));*/
    ...
    private void showFragment(String pFragmentName, boolean addToBackStack) {
      ...
      /*  if (pFragmentName.equals(FONTESPAGER)) {
        ...
        if (pFragmentName.equals(WEIGHT)) {
